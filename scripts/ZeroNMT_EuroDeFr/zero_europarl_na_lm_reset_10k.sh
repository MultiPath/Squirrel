...
python -m torch.distributed.launch --nproc_per_node=${gpus} --master_port=${port} \
                ...
                --model 'Transformer' \
                --lang_as_init_token \
                --load_from 12.25_02.53.00.LM.de-fr-eval-nonoverlap_t2t-base_de,en,fr,en_en,de,en,fr_Transformer_wf_lm300000_bpe_0.1_9600__iter=10000 \
                --seed ${seed} \
